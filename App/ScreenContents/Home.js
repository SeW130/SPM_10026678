...
const image = { uri: "http://critssl.com/img/bgImg.jpg" };
       ...
       axios
           ...
           .then(data => {
             ...
             for (var i = 0; i < data.data.length; i++) {
                 this.state.items.push({ name: data.data[i].name,description: data.data[i].description,qty: data.data[i].qty,price: data.data[i].sellingPrice, code: '#dce3e3' ,image:'http://192.168.8.101/Food/img/'+data.data[i].id+'.jpg',id:data.data[i].id});
             }
